...
$(function() {
  ...
  $('#deal-button').click(function() {
    ...
    //Hides the deal button and displays Hit, Stand, and Double buttons
    $("#deal-button").hide();
    $('#hit-button').show();
    $('#stand-button').show();
    $('#dbl-button').show();
...
//Event handler for Stand button click
  ...
  $('#dbl-button').click(function() {
    $("#dbl-button").hide();
    $("#hit-button").hide();
    $('#stand-button').hide();
    // bet is doubled
    new_bet_amount = bet_amount * 2;
    $("#current_bet").text("$"+ new_bet_amount);
    // player is dealt a single card
    player_deal();
    p_points = playerHand.getPoints();
    // dealer's hidden card is shown
    $("#hidden_card").attr("src", hidden_image_url);
    d_points = dealerHand.getPoints();
    $("#player-points").text(p_points);
    $("#dealer-points").text(d_points);
